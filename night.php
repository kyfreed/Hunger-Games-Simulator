...
function weightedActionChoice($key) {
    ...
    if ($_SESSION['castObjectToday'][$key]->strength < 1.5 && in_array("a first aid kit", $_SESSION['castObjectToday'][$key]->inventory) && $_SESSION['castObjectToday'][$key]->daysWithoutFood == 0) {
